        ...
        <div className="container">
          <div>
            <ul className='flex flex-col gap-[20px]'>
              ...
              <NavLink to="/category" className={({ isActive }) => isActive ? 'text-[14px] font-semibold font-poppins text-[#fff] px-[21px] py-[17px] bg-[#7364DB] rounded-2xl' : "text-[14px] font-semibold font-poppins text-[#7E7E8F] px-[21px] py-[17px]"}>Category</NavLink>
              ...
              <NavLink to="/productDetails" className={({ isActive }) => isActive ? 'text-[14px] font-semibold font-poppins text-[#fff] px-[21px] py-[17px] bg-[#7364DB] rounded-2xl' : "text-[14px] font-semibold font-poppins text-[#7E7E8F] px-[21px] py-[17px]"}>Add Product</NavLink>
